...
function checkLoginStatus() {
    const userData = localStorage.getItem('azelhost_user');
    if (userData) {
    ...
    const modalHTML = `
        <div class="modal" id="planModal">
            <div class="modal-content">
                ...
                <h2 class="modal-title"><i class="fas fa-shopping-cart"></i> ${plan.name}</h2>
                ...
                <div class="plan-details">
                    <div class="price-display">
                        <div class="monthly">
                            ...
                            <button class="btn neon-btn" onclick="subscribeToPlan('${planType}', 'monthly')">
                        ...
                        <div class="yearly">
                            ...
                            <button class="btn neon-btn" onclick="subscribeToPlan('${planType}', 'yearly')">
...
function subscribeToPlan(planType, period) {
    const user = JSON.parse(localStorage.getItem('azelhost_user') || '{}');
    ...
    showLoading(`جاري تفعيل خطة ${planType}...`);
    ...
    setTimeout(() => {
        ...
        showNotification(`🎉 تم تفعيل الخطة بنجاح!`, 'success');
...
// إضافة أنيميشن الإشعارات إذا لم تكن موجودة
